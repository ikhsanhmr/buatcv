...
@section('content')
	        ...
	        <div class="row">
	            <div class="col-lg-6 ">
	                <div class="media img-block mb-3 mb-lg-0">
	                    <img src="assets/images/about/h-1.jpg" alt="" class="img-fluid rounded mr-3">
	            ...
	            <div class="col-lg-6">
	                <div class="media img-block">
	                    <img src="assets/images/about/h-2.jpg" alt="" class="img-fluid rounded mr-3">
	...
	<section class="section-padding bg-gray" >
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-lg-3 col-md-6">
	                <img src="assets/images/team/team-1.jpg" alt="" class="img-fluid rounded w-100">
	            ...
	            <div class="col-lg-3 col-md-6">
	                <img src="assets/images/team/team-2.jpg" alt="" class="img-fluid rounded w-100">
	            ...
	            <div class="col-lg-3 col-md-6">
	                <img src="assets/images/team/team-3.jpg" alt="" class="img-fluid rounded w-100">
	            ...
	            <div class="col-lg-3 col-md-6">
	                <img src="assets/images/team/team-4.jpg" alt="" class="img-fluid rounded w-100">
